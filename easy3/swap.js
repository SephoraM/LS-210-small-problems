...
// string => string
// split the string into its word parts
// iterate over each word, swaping the last letter and the first letter of the
// word.
// join the rewritten words into a new string and return
