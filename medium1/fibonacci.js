...
//
// NOTE: This exercise verges on the Advanced level of exercises, so do not be discouraged
// if you are not able to solve it on your own; recursion is tricky, and even experienced
// developers can have difficulty dealing with it.

// input: number which is the nth fibonacci number
// output: number which is the computed nth fibonacci number
// rules:
// F(1) = 1
// F(2) = 1
// F(n) = F(n - 1) + F(n - 2) where n > 2
// ending condition: if n <= 2 return 1
// else
